...
class Adafruit_HMC5883 : public Adafruit_Sensor {
public:
  /*!
   * @param sensorID sensor ID, -1 by default
   */
  Adafruit_HMC5883(int32_t sensorID = -1);

  bool begin(hmc5883MagGain gain, TwoWire *wire); //!< @return Returns whether connection was successful
